...
> 3. Tell me the case has been added and ask me to run the eval suite in Step 4 with the new case included
>
...
> ```
> Wait for me to confirm the results before proceeding. I will tell you the pass/fail count and flag any failures. If I report failures, stop here and fix them before we continue. Do not proceed to Step 5 or beyond until I explicitly confirm the eval results.
>
> **Step 5 — README check**
...
>
> **Step 6 — Observability & logging check**
...
>
> If logging or analytics updates are needed, propose exactly what should change and wait for my approval before touching anything. If nothing needs to change, explain why and move on to Step 7.
>
...
> 3. Eval results as confirmed by me in Step 4
> 4. Any README sections that were updated
> 5. Any logging or analytics changes made in Step 6
>
